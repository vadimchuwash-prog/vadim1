"""
🤖 BOT MODULES PACKAGE v1.4.9
Модульная структура торгового бота

ИСПРАВЛЕНИЯ v1.4.9:
- 🎯 АДАПТИВНАЯ активация трейлинга (привязана к динамическому TP!)
- 📊 TREND: активация при 70% пути к TP (было 50%)
- 📊 RANGE: активация при 50% пути к TP (было фиксированные 0.15%)
- Пример: если TP = 0.35%, RANGE активируется при +0.175%
